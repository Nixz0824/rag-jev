...
| 工程 | 一个 notebook | 82 项单元测试 + GitHub Actions + 进程 Job Object + 索引指纹 + 公告原文不入库 |
...
```powershell
python -m unittest discover -s tests          # 82 项，不需要模型与网络
